...
Both fluoride gravity and auto teams are also currently working with bottom geometry team to improve the design of bottom geometry in the reactor to improve floc recirculation. This can potentially improve the floc blanket formation, and since only gel formation has been observed with fluoride particles in the reactor, a new bottom geometry design should be able to prohibit floc aggregation at the bottom of the reactor.
